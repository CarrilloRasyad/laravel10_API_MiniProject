...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return response()->json([
            'status' => $product->count() ? 'Success' : 'Error',
            'message' => $product->count() ? 'Data has found' : 'Data not found',
            'data' => $product
        ], $product->count() ? 200 : 404);
    }
    ...
    public function show(string $id)
    {
        ...
        return response()->json([
            'status' => $product->count() ? 'Success' : 'Error',
            'message' => $product->count() ? 'Data found' : 'Data not found',
            'data' => $product
        ], $product->count() ? 200 : 404);
